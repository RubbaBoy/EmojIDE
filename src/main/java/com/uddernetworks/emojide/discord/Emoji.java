...
public enum Emoji {
    ...
    Emoji(String name, String unicodeOrPath) {
        this.name = name;
    ...
    //TODO:
    //    In the EmojiManager, go through each one of these Emojis and if it isCustom(), ensure the emoji is found. If
    //    not, upload it to the next server in a list with slots open. Then get its ID and populate it via this.id Then,
    //    update this.display to reflect <:name:id> for custom ones.
